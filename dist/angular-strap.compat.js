...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.typeahead', [ 'mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions' ]).provider('$bsTypeahead', function() {
    ...
    this.$get = ["$window", "$rootScope", "$mgcreaTooltip", "$$rAF", "$timeout", function($window, $rootScope, $mgcreaTooltip, $$rAF, $timeout) {
  ...
  angular.module('mgcrea.ngStrap.timepicker', [ 'mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.helpers.dateFormatter', 'mgcrea.ngStrap.tooltip' ]).provider('$bsTimepicker', function() {
    ...
    this.$get = ["$window", "$document", "$rootScope", "$sce", "$bsDateFormatter", "$mgcreaTooltip", "$timeout", function($window, $document, $rootScope, $sce, $dateFormatter, $mgcreaTooltip, $timeout) {
  ...
  angular.module('mgcrea.ngStrap.tooltip', [ 'mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions' ]).provider('$mgcreaTooltip', function() {
    var defaults = this.defaults = {
      animation: 'am-fade',
      customClass: '',
      prefixClass: 'tooltip',
  ...
  }).directive('bsTooltip', ["$window", "$location", "$sce", "$parse", "$mgcreaTooltip", "$$rAF", function($window, $location, $sce, $parse, $mgcreaTooltip, $$rAF) {
    return {
      restrict: 'EAC',
      scope: true,
  ...
  angular.module('mgcrea.ngStrap.select', [ 'mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions' ]).provider('$bsSelect', function() {
    ...
    this.$get = ["$window", "$document", "$rootScope", "$mgcreaTooltip", "$timeout", function($window, $document, $rootScope, $mgcreaTooltip, $timeout) {
      var isNative = /(ip[ao]d|iphone|android)/gi.test($window.navigator.userAgent);
      var isTouch = 'createTouch' in $window.document && isNative;
  ...
  angular.module('mgcrea.ngStrap.dropdown', [ 'mgcrea.ngStrap.tooltip' ]).provider('$bsDropdown', function() {
    ...
    this.$get = ["$window", "$rootScope", "$mgcreaTooltip", "$timeout", function($window, $rootScope, $mgcreaTooltip, $timeout) {
      var bodyEl = angular.element($window.document.body);
  ...
  angular.module('mgcrea.ngStrap.datepicker', [ 'mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.helpers.dateFormatter', 'mgcrea.ngStrap.tooltip' ]).provider('$bsDatepicker', function() {
    ...
    this.$get = ["$window", "$document", "$rootScope", "$sce", "$bsDateFormatter", "bsDatepickerViews", "$mgcreaTooltip", "$timeout", function($window, $document, $rootScope, $sce, $dateFormatter, datepickerViews, $mgcreaTooltip, $timeout) {
      var isNative = /(ip[ao]d|iphone|android)/gi.test($window.navigator.userAgent);
      var isTouch = 'createTouch' in $window.document && isNative;
